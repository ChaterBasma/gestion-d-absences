            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('filieres.update', $filiere) }}">
                        ...
                        <div class="mb-4">
                            <label for="CodeF" class="block text-sm font-medium mb-2">Code (lecture seule)</label>
                            <input type="text" id="CodeF" value="{{ $filiere->CodeF }}"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="Libelle" name="Libelle" value="{{ old('Libelle', $filiere->Libelle) }}"
