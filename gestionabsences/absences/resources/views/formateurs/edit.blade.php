<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Modifier le formateur') }} {{ $formateur->Nom }}
        </h2>
    </x-slot>
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('formateurs.update', $formateur) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="Matricule" name="Matricule" value="{{ old('Matricule', $formateur->Matricule) }}"
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="Nom" name="Nom" value="{{ old('Nom', $formateur->Nom) }}"
                                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700"
                                required>
                            @error('Nom')
                                <span class="text-red-600 text-sm">{{ $message }}</span>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="Prenom" name="Prenom" value="{{ old('Prenom', $formateur->Prenom) }}"
                                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700"
                                required>
                            @error('Prenom')
                                <span class="text-red-600 text-sm">{{ $message }}</span>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email', $formateur->email) }}"
                                class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700"
                                required>
                            @error('email')
                                <span class="text-red-600 text-sm">{{ $message }}</span>
